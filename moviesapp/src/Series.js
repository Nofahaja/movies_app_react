...
export default function Series() {
  ...
  useEffect(()=>{
    axios.get(`https://api.themoviedb.org/3/tv/popular?api_key=6cdf1bc39c14d06f4b51e70d622928f4&language=en-US&page=1`).then (response=>{
...
const singleview=(id)=>{
  ...
  return (
    <div>
    <h1 className='scrollh1'> Popular Series </h1> 
...
<img className='scrollimg' onClick={()=>{handleOpen();singleview(Ser.id)}}src={`https://image.tmdb.org/t/p/original${Ser.poster_path}`} alt=''/>
</div>
</>
))}
</div>
