...
console.log(state);
  ...
  return (
    <div>
                   <h1 className='scrollh1'>Trending Movies</h1> 
    ...
    <div className="scroll">
      ...
      {Trending.map((trend)=>(
       ...
       <div className='imagesscrolling'>
        <img className='scrollimg' onClick={()=>{handleOpen();singleview(trend.id);}} src={`https://image.tmdb.org/t/p/original${trend.poster_path}`} alt=''/>
         </div>
         </>
        ))}
        </div>
