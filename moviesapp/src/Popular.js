...
console.log(state);
  ...
  return (
    <div>
      <h1 className='scrollh1'>Popular Movies</h1> 
    ...
    <div className="scroll">
      ...
      {Popular?.map((pop)=>(
       ...
       <div className='imagesscrolling'>
        <img className='scrollimg' onClick={()=>{handleOpen();singleview(pop.id)}} src={`https://image.tmdb.org/t/p/original${pop.poster_path}`} alt=''/>
         </div>
         </>
        ))}
        </div>
