...
export default function Toprated() {
  ...
  useEffect(()=>{
    axios.get(`https://api.themoviedb.org/3/movie/top_rated?api_key=6cdf1bc39c14d06f4b51e70d622928f4&language=en-US&page=1`).then (response=>{
...
console.log(state);
  ...
  return (
    <div>
                   <h1 className='scrollh1'>Top-rated Movies</h1> 
    ...
    <div className="scroll">
      ...
      {Toprated.map((top)=>(
       ...
       <div className='imagesscrolling'>
        <img className='scrollimg'   onClick={()=>{handleOpen();singleview(top.id)}} src={`https://image.tmdb.org/t/p/original${top.poster_path}`} alt=''/>
         </div>
         </>
        ))}
        </div>
    ...
    <Modal
      ...
      <div className="scrolling">
       ...
       <iframe width="700" height="315" src={`https://www.youtube.com/embed/${state.video==""?"":state?.video?.results[2]?.key}`} title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <div className="cls">
